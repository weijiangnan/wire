 ...
 */
class WireCompiler2 internal constructor(
        val fs: FileSystem,
        val log: WireLogger,
    ...
    for (protoFile in schema.protoFiles()) {
      ...
      when {
        javaOut != null -> {
          ...
          val javaGenerator = JavaGenerator2.get(schema, true)
                  .withProfile(profile)
                  .withAndroid(emitAndroid)
                  .withAndroidAnnotations(emitAndroidAnnotations)
                  .withCompact(emitCompact)

          val task = JavaFileWriter2(javaOut, protoFile, javaGenerator, types, dryRun, fs, log)
  ...
  companion object {
    ...
    fun forArgs(
      ...
      return WireCompiler2(fileSystem, logger, protoPaths, javaOut, kotlinOut, sourceFileNames,
